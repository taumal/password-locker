...
//        content.append("<a href=\"").append(confirmationUrl).append("\">").append(confirmationUrl).append("</a></p>");
        ...
        content.append("<meta property=\"og:title\" content=\"Verify Your Email\">");
        content.append("<title>Verify Your Email</title>");
        content.append("<style type=\"text/css\">");
        content.append("#outlook a{padding:0;}").append("body{width:100% !important;}").append(".ReadMsgBody{width:100%;}");
        content.append(".ExternalClass{" +
                "        width:100%; " +
                "      } " +
                "      body{ " +
        ...
        content.append("/* " +
                ...
                "      padding-bottom: 20px; " +
                "    }");
        content.append("@media only screen and (min-device-width: 320px) and (max-device-width: 480px) { " +
                "            h1 { " +
        ...
        content.append("</head>");
        content.append("<body leftmargin=\"0\" marginwidth=\"0\" topmargin=\"0\" marginheight=\"0\" offset=\"0\" style=\"width:100% ;-webkit-text-size-adjust:none;margin:0;padding:0;background-color:#FAFAFA;\"> " +
                "  <center> " +
                ...
                "                      <img width=\"130\" src=\"http://localhost:8085/img/logo_bg_white.png\" style=\"width:80px;max-width:80px;border:0;height:auto;line-height:100%;outline:none;text-decoration:none;\" id=\"headerImage campaign-icon\"> " +
                ...
                "                              <h1 class=\"h1\" style=\"color:#202020;display:block;font-family:Arial;font-size:24px;font-weight:bold;line-height:100%;margin-top:20px;margin-right:0;margin-bottom:20px;margin-left:0;text-align:center;\">Hello "+recipientName+"</h1> " +
                " " +
                "                              <h2 class=\"h2\" style=\"margin-bottom: 30px;color: #999;font-family:Poppins,Helvetica,Arial,sans-serif;font-size: 16px;font-weight: 300;font-style: normal;letter-spacing: normal;line-height: 24px;text-transform: none;text-align: center;\">Verify Your Email</h2> " +
                "                                                           <!-- <h3 class=\"h3\">Heading 3</h3> " +
                "                                                                <h4 class=\"h4\">Heading 4</h4> --> " +
                "                              <p>You registered an account on \"My Vaults\", before being able to use your account you need to verify that this is your email address. Please click the button below to verify your email.</p> " +
                "                            </div> " +
                "                          </td> " +
                "                        </tr> " +
                "                        <tr> " +
                ...
                "                                    <a class=\"buttonText\" href=\""+confirmationUrl+"\" target=\"_blank\" style=\"color: #4A90E2;text-decoration: none;font-weight: normal;display: block;border: 2px solid #585858;padding: 10px 80px;font-family: Arial;\">Verify</a> " +
                "                                  </td> " +
                "                                </tr> " +
                "                              </tbody> " +
                "                            </table> " +
                ...
                "                              <p>Or? Copy the following link and paste in your browser. <br> " +
                "                                <a href=\""+confirmationUrl+"\" style=\"color:#4a90e2;font-weight:normal;text-decoration:underline; font-size: 12px;\">"+confirmationUrl+"</a>.</p> " +
                "                            </div> " +
                "                            <br> " +
                "                          </td> " +
                "                        </tr> " +
                ...
                "                        <p style=\"text-align:left;margin:0;margin-top:2px;\">My Vaults | Copyright © "+year+" | All rights reserved</p> " +
                "                      </div> " +
                "                      <!-- // End Module: Standard Footer \\\\ --> " +
                "                    </td> " +
                "                  </tr> " +
